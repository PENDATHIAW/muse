...
BEGIN
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/1346f3bb-2b57-4d9f-9e2d-51797e11bb78.png', 'VIDE-POCHE TERANGA REF M05 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/15a0820e-e669-4c4d-9c84-51cd133a0c0f.png', 'VIDE-POCHE TERANGA REF M06 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/1a4cd869-5e17-4689-bb01-fd44d50bc2b8.png', 'VIDE-POCHE TERANGA REF M07 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    INSERT INTO public.products (
      ...
      'Tasbih, natte ou accessoires — RANGE NATTE REF M03 leur offre enfin une place digne.',
      'RANGE NATTE REF M03 transforme un geste simple en rituel soigné. Posez, respirez, reprenez : chaque détail est pensé pour durer et embellir votre pratique. Signé MUSE, imprimé sur commande.',
      'Posez tasbih, natte ou accessoires de prière sur le support. Organisez votre coin prière avec élégance et pudeur.',
      'Inspiré des rituels de prière et de recueillement — des objets beaux, sobres et fonctionnels pour votre espace Salaah.',
      'Coin prière, chambre, salon discret, bureau de prière ou espace méditation.',
      10000,
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/1cfb5cb4-db54-4739-8f2f-3a6aabfcc4cd.png', 'RANGE NATTE REF M03 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    INSERT INTO public.products (
      ...
      'Entre deux prières, SUPPORT TASBIH REF M04 vous attend — beau, stable, personnalisable.',
      'Sobriété ne veut pas dire tristesse. SUPPORT TASBIH REF M04 apporte chaleur et ordre à votre Salaah — support tasbih, range natte ou coin prière selon le modèle. Finition premium, personnalisation facile.',
      'Posez tasbih, natte ou accessoires de prière sur le support. Organisez votre coin prière avec élégance et pudeur.',
      'Inspiré des rituels de prière et de recueillement — des objets beaux, sobres et fonctionnels pour votre espace Salaah.',
      'Coin prière, chambre, salon discret, bureau de prière ou espace méditation.',
      10000,
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/1f0b23e7-9f05-4bc7-a95c-3e5d3963cf06.png', 'SUPPORT TASBIH REF M04 MUSE', true, 0);
  END IF;

  -- SUPPORT TASBIH REF M05
  SELECT id INTO v_universe_id FROM public.universes WHERE slug = 'salaah';
  IF v_universe_id IS NOT NULL THEN
    INSERT INTO public.products (
      universe_id, name, slug, short_description, long_description,
      ...
      'Votre coin prière mérite autant de soin que votre salon. SUPPORT TASBIH REF M05 — sobriété, beauté, recueillement.',
      'SUPPORT TASBIH REF M05 est pensé pour accompagner vos moments de Salaah avec respect et esthétique. Imprimé en 3D par MUSE, il accueille tasbih, natte ou petits accessoires de prière avec une finition sobre et durable. Couleur, motif discret ou initiales : personnalisation MUSE incluse.',
      'Posez tasbih, natte ou accessoires de prière sur le support. Organisez votre coin prière avec élégance et pudeur.',
      'Inspiré des rituels de prière et de recueillement — des objets beaux, sobres et fonctionnels pour votre espace Salaah.',
      'Coin prière, chambre, salon discret, bureau de prière ou espace méditation.',
      10000,
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/2075d708-8839-4081-9b32-a1e9c3e9700b.png', 'SUPPORT TASBIH REF M05 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/2a676412-2db1-4b8e-8efe-b0da9d1f8bac.png', 'VIDE-POCHE TERANGA REF M13 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/2bb50489-f1a2-4793-af05-9979caffb5c3.png', 'VIDE-POCHE TERANGA REF M14 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/319774fd-d4a4-40d1-8c8f-792dd7a826e5.png', 'VIDE-POCHE TERANGA REF M15 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/3261cbd8-830f-4d86-ae61-9dd27b0a79dc.png', 'VIDE-POCHE TERANGA REF M16 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/34ce5036-160d-41f1-88e7-14cc0e8738fb.png', 'VIDE-POCHE TERANGA REF M17 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/3754cc1b-e544-42c5-991c-675b4054a3b4.png', 'VIDE-POCHE TERANGA REF M18 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    INSERT INTO public.products (
      ...
      'COIN PRIÈRE REF M06 : l''objet Salaah qui structure votre rituel avec élégance et pudeur.',
      'Un espace de prière harmonieux change la qualité du recueillement. COIN PRIÈRE REF M06 structure votre coin Salaah sans ostentation — lignes épurées, matériaux soignés, usage quotidien. Bureau de prière, chambre ou salon discret.',
      'Posez tasbih, natte ou accessoires de prière sur le support. Organisez votre coin prière avec élégance et pudeur.',
      'Inspiré des rituels de prière et de recueillement — des objets beaux, sobres et fonctionnels pour votre espace Salaah.',
      'Coin prière, chambre, salon discret, bureau de prière ou espace méditation.',
      10000,
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/3805ca06-c788-4f55-8c28-f6732a6b18af.png', 'COIN PRIÈRE REF M06 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/393bb64e-cc7f-4b79-b9aa-69174ef68399.png', 'VIDE-POCHE TERANGA REF M19 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/3a974963-994b-49e0-a453-ea3017c8e88e.png', 'VIDE-POCHE TERANGA REF M20 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/3aa7ce75-1e08-46d8-8135-1bbf1c3f4bac.png', 'VIDE-POCHE TERANGA REF M21 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/3fd6c3cb-893d-44d3-b208-cc599ce892e0.png', 'VIDE-POCHE TERANGA REF M22 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/406bb427-b3cc-428d-8bfb-b59023cdf558.png', 'VIDE-POCHE TERANGA REF M23 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/40958511-78ef-43fc-82eb-c4439842555f.png', 'VIDE-POCHE TERANGA REF M24 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/425af7e7-44d1-45eb-9af1-8dbf9fc32a15.png', 'VIDE-POCHE TERANGA REF M25 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/46f996d7-9a09-4d08-8f3d-91d08b737ceb.png', 'VIDE-POCHE TERANGA REF M26 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/477d3822-29e0-4a19-aeec-30a57991cddd.png', 'VIDE-POCHE TERANGA REF M27 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/4865d9ef-d2a4-4a8b-b73f-1781076c768f.png', 'VIDE-POCHE TERANGA REF M28 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/49106b4d-cd4b-4caf-ba3c-1adfc7cb2442.png', 'VIDE-POCHE TERANGA REF M29 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/492429f0-a42c-4511-990c-932e60e86757.png', 'VIDE-POCHE TERANGA REF M30 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/4ea5518b-d972-4636-9a7c-112582388c9d.png', 'VIDE-POCHE TERANGA REF M31 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/53fb0795-f056-4c7a-bfc3-e3edcaff2280.png', 'VIDE-POCHE TERANGA REF M32 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/54951c40-33a0-4590-b396-d4d8782263c6.png', 'VIDE-POCHE TERANGA REF M33 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/56e9be07-a72c-4871-9ed8-0cae3fe65781.png', 'VIDE-POCHE TERANGA REF M34 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/56f0e63c-6934-4d52-af16-91d8d73ef32b.png', 'VIDE-POCHE TERANGA REF M35 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/58f189c9-3f6f-456b-8344-f8ecf25dc5bd.png', 'VIDE-POCHE TERANGA REF M36 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/5a9726f6-1a57-4eb8-a0ba-f706e4964ebe.png', 'VIDE-POCHE TERANGA REF M37 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/5b3df704-1e48-4ec1-be11-950eab7ad873.png', 'VIDE-POCHE TERANGA REF M38 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/5b9ce444-17e8-4d0a-90a3-277a85b48b2f.png', 'VIDE-POCHE TERANGA REF M39 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    INSERT INTO public.products (
      ...
      'Tasbih, natte ou accessoires — RANGE NATTE REF M07 leur offre enfin une place digne.',
      'RANGE NATTE REF M07 transforme un geste simple en rituel soigné. Posez, respirez, reprenez : chaque détail est pensé pour durer et embellir votre pratique. Signé MUSE, imprimé sur commande.',
      'Posez tasbih, natte ou accessoires de prière sur le support. Organisez votre coin prière avec élégance et pudeur.',
      'Inspiré des rituels de prière et de recueillement — des objets beaux, sobres et fonctionnels pour votre espace Salaah.',
      'Coin prière, chambre, salon discret, bureau de prière ou espace méditation.',
      10000,
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/5bf061a9-000d-425e-83f1-9f6cef4af25a.png', 'RANGE NATTE REF M07 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/5c4cef1e-ac79-4e10-9226-0199b9b90b55.png', 'VIDE-POCHE TERANGA REF M40 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/5fe2299c-2058-45f1-953b-a5188cc3cbde.png', 'VIDE-POCHE TERANGA REF M41 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/60160835-9fbe-4e59-a713-d919c6bd5c41.png', 'VIDE-POCHE TERANGA REF M42 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/638565cc-3fbe-4742-8025-2168256555d5.png', 'VIDE-POCHE TERANGA REF M43 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/649f2ced-ce67-4d02-bbdb-2122c77ae275.png', 'VIDE-POCHE TERANGA REF M44 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/66b26fe6-ccf5-460b-8902-44d9bd58c5f6.png', 'VIDE-POCHE TERANGA REF M45 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/670436f4-e5dc-41ee-a12c-0f5037cdf17b.png', 'VIDE-POCHE TERANGA REF M46 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/684045cb-cf90-4edf-9481-71fc5158ef56.png', 'VIDE-POCHE TERANGA REF M47 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/6c385814-fd15-4826-89d5-663de9c1a679.png', 'VIDE-POCHE TERANGA REF M48 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/6e3b7dad-3db1-448c-b3df-d2eb565f3041.png', 'VIDE-POCHE TERANGA REF M49 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/6f81e766-2c98-42eb-9963-914a452ba95e.png', 'VIDE-POCHE TERANGA REF M50 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/701e7cad-2e6f-4adb-8782-031d68758ec0.png', 'VIDE-POCHE TERANGA REF M51 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/71b28e42-aaf9-4014-8309-f33ab41826a9.png', 'VIDE-POCHE TERANGA REF M52 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/71c76ed6-42d8-44c7-8f23-de6c8ad51861.png', 'VIDE-POCHE TERANGA REF M53 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/724c4222-7896-40ad-a6b8-dc042cfbf636.png', 'VIDE-POCHE TERANGA REF M54 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/72e33712-6df9-4227-9143-416e82e126cb.png', 'VIDE-POCHE TERANGA REF M55 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/72fc7323-8a59-4003-a325-3bef4a09107c.png', 'VIDE-POCHE TERANGA REF M56 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/737e1d1d-c32f-4daa-b007-a6a3d933ef29.png', 'VIDE-POCHE TERANGA REF M57 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/7411cb82-60c5-4e0a-86f7-5dee795a9150.png', 'VIDE-POCHE TERANGA REF M58 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/7610c090-6736-443b-9936-68fbb7cac601.png', 'VIDE-POCHE TERANGA REF M59 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/76ac758b-74a5-45d8-b764-2e97b0d1d74d.png', 'VIDE-POCHE TERANGA REF M60 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/772df2fc-0358-4d6f-abb6-c9d64c003421.png', 'VIDE-POCHE TERANGA REF M61 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/79679bd7-d285-4eb2-9815-7d4716c494d4.png', 'VIDE-POCHE TERANGA REF M62 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/797055d8-1423-4406-9e0b-b5b0e895a600.png', 'VIDE-POCHE TERANGA REF M63 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/7b7133f7-1fea-4ff0-a513-250c2b96ec00.png', 'VIDE-POCHE TERANGA REF M64 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/7c7a5280-5662-43e9-b1c9-e37a9c986183.png', 'VIDE-POCHE TERANGA REF M65 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/7db3328e-e1de-4918-be3b-0449e053d25c.png', 'VIDE-POCHE TERANGA REF M66 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/7ec427f0-9563-485d-aaa9-0d83640e2352.png', 'VIDE-POCHE TERANGA REF M67 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/808ac9ed-e725-430b-ac6e-af6b42a3a054.png', 'VIDE-POCHE TERANGA REF M68 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/84bda87e-9dac-4f7a-b39b-aa812d52fa3f.png', 'VIDE-POCHE TERANGA REF M69 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    INSERT INTO public.products (
      ...
      'Entre deux prières, SUPPORT TASBIH REF M08 vous attend — beau, stable, personnalisable.',
      'Sobriété ne veut pas dire tristesse. SUPPORT TASBIH REF M08 apporte chaleur et ordre à votre Salaah — support tasbih, range natte ou coin prière selon le modèle. Finition premium, personnalisation facile.',
      'Posez tasbih, natte ou accessoires de prière sur le support. Organisez votre coin prière avec élégance et pudeur.',
      'Inspiré des rituels de prière et de recueillement — des objets beaux, sobres et fonctionnels pour votre espace Salaah.',
      'Coin prière, chambre, salon discret, bureau de prière ou espace méditation.',
      10000,
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/8591e1a1-052c-4691-a119-87a051468180.png', 'SUPPORT TASBIH REF M08 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/867e9ed3-19fc-4035-aa1e-a20639f744d3.png', 'VIDE-POCHE TERANGA REF M70 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/87a930a8-ed5f-4690-960a-2675996ad22a.png', 'VIDE-POCHE TERANGA REF M71 MUSE', true, 0);
  END IF;

  -- SUPPORT TASBIH REF M09
  SELECT id INTO v_universe_id FROM public.universes WHERE slug = 'salaah';
  IF v_universe_id IS NOT NULL THEN
    INSERT INTO public.products (
      universe_id, name, slug, short_description, long_description,
      ...
      'Votre coin prière mérite autant de soin que votre salon. SUPPORT TASBIH REF M09 — sobriété, beauté, recueillement.',
      'SUPPORT TASBIH REF M09 est pensé pour accompagner vos moments de Salaah avec respect et esthétique. Imprimé en 3D par MUSE, il accueille tasbih, natte ou petits accessoires de prière avec une finition sobre et durable. Couleur, motif discret ou initiales : personnalisation MUSE incluse.',
      'Posez tasbih, natte ou accessoires de prière sur le support. Organisez votre coin prière avec élégance et pudeur.',
      'Inspiré des rituels de prière et de recueillement — des objets beaux, sobres et fonctionnels pour votre espace Salaah.',
      'Coin prière, chambre, salon discret, bureau de prière ou espace méditation.',
      10000,
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/897f4b4b-5cb5-4f65-b960-166aab3a8747.png', 'SUPPORT TASBIH REF M09 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/89f83c9e-97fb-4f65-b8b4-367c4621449d.png', 'VIDE-POCHE TERANGA REF M72 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/8d2a271c-66b9-4b1e-b95f-f4c20dd0e216.png', 'VIDE-POCHE TERANGA REF M73 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/8e606702-c3b2-4b1f-bf04-38bc9bdfd24d.png', 'VIDE-POCHE TERANGA REF M74 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/8e9df991-5404-4c6a-ade9-cb19e259bb94.png', 'VIDE-POCHE TERANGA REF M75 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/8f2dd6ab-ce35-499a-8593-2fc9cb4cda5c.png', 'VIDE-POCHE TERANGA REF M76 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/8fb8ee7d-87ea-460f-9f38-56c9da4e58ee.png', 'VIDE-POCHE TERANGA REF M77 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/8fc36753-9cc5-4a4f-8dda-dc4851d93479.png', 'VIDE-POCHE TERANGA REF M78 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/900bbe02-30cd-463b-ab6e-2d65075b5110.png', 'VIDE-POCHE TERANGA REF M79 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/91c140fc-9200-44bb-9b14-63e1b0f221e4.png', 'VIDE-POCHE TERANGA REF M80 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/91eadfe6-5112-498d-a845-dbd1a042e2c6.png', 'VIDE-POCHE TERANGA REF M81 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/92169e75-5489-48c8-a122-afc85d748406.png', 'VIDE-POCHE TERANGA REF M82 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/95e4bc36-204f-4be5-81b9-d00f62356092.png', 'VIDE-POCHE TERANGA REF M83 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/9605307e-6dcd-4ff8-a852-9e55ca04d5ce.png', 'VIDE-POCHE TERANGA REF M84 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    INSERT INTO public.products (
      ...
      'COIN PRIÈRE REF M10 : l''objet Salaah qui structure votre rituel avec élégance et pudeur.',
      'Un espace de prière harmonieux change la qualité du recueillement. COIN PRIÈRE REF M10 structure votre coin Salaah sans ostentation — lignes épurées, matériaux soignés, usage quotidien. Bureau de prière, chambre ou salon discret.',
      'Posez tasbih, natte ou accessoires de prière sur le support. Organisez votre coin prière avec élégance et pudeur.',
      'Inspiré des rituels de prière et de recueillement — des objets beaux, sobres et fonctionnels pour votre espace Salaah.',
      'Coin prière, chambre, salon discret, bureau de prière ou espace méditation.',
      10000,
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/98bb90d8-7c18-41a3-994d-8f82b58b5adb.png', 'COIN PRIÈRE REF M10 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/9b333ee9-7dfc-4b8e-9852-0e513852d9cc.png', 'VIDE-POCHE TERANGA REF M85 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/9b836607-44a1-46a3-baf4-c4bd214485bf.png', 'VIDE-POCHE TERANGA REF M86 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/9de9b67f-e0f4-457b-91dc-303ad11cfc3e.png', 'VIDE-POCHE TERANGA REF M87 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/9f7145eb-8c11-419b-8403-ae42d7517231.png', 'VIDE-POCHE TERANGA REF M88 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/a0088906-05b5-49b5-9882-dc3e456d3948.png', 'VIDE-POCHE TERANGA REF M89 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/a011018a-c171-440d-8482-14b7a91ef168.png', 'VIDE-POCHE TERANGA REF M90 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/a184538c-9616-4bee-8c4c-efdb07a12a54.png', 'VIDE-POCHE TERANGA REF M91 MUSE', true, 0);
  END IF;
  ...
  IF v_universe_id IS NOT NULL THEN
    ...
    DELETE FROM public.product_images WHERE product_id = v_product_id;
    INSERT INTO public.product_images (product_id, image_url, alt_text, is_main, display_order)
    VALUES (v_product_id, '/products/a19fa959-fb26-4cf9-946f-c8ba57aa2045.png', 'VIDE-POCHE TERANGA REF M92 MUSE', true, 0);
  END IF;
